...
public class ReplaceableBitmapDrawable extends Drawable {
	private static final String TAG = "ReplaceableBitmapDraw";
	...
	public int getIntrinsicWidth() {
		if (mBitmap != null) {
			if (DEBUG) 
				Log.i(TAG, "getIntrinsicWidth(): " + mBitmap.getWidth()+ " " + this);
	...
	public int getIntrinsicHeight() {
		if (mBitmap != null) {
			if (DEBUG) 
				Log.i(TAG, "getIntrinsicHeight(): " + mBitmap.getHeight() + " " + this);
